...
from app.api.content.prompt_generator import router as prompt_generator_router

__all__ = ["text_router", "images_router", "unified_content_router", "prompt_generator_router"]
